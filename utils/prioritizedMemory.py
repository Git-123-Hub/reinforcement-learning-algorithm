...
class prioritizedMemory:
    def __init__(self, capacity, batch_size, alpha, beta):
        ...
        self.sample_index = np.zeros(capacity, dtype=int)
    ...
    def sample(self):
        experiences = np.zeros(self.capacity, dtype=object)
        priorities = np.zeros(self.capacity, dtype=np.float64)
